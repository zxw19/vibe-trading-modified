...
description: Earnings estimate revisions, guidance analysis, and post-earnings drift (PEAD) — track analyst consensus changes, earnings surprise patterns, and management guidance shifts for A-share equities.
category: analysis
---
...
- Earnings season: Apr (annual), Aug (interim), Oct (Q3), with deadlines set by exchange rules
- Reporting frequency: Quarterly for most A-share companies
- Consensus data available through Eastmoney / Tushare research report endpoints
- Analyst coverage varies widely by market cap
...
- Earnings revision data can be sourced from Eastmoney research reports and Tushare financial data for A-share consensus tracking
